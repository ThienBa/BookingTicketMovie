...
import { getListTypeUserApiAction, updateInfoPostUserApiAction } from '../../../../redux/actions/UserActions';
import { useSelector } from 'react-redux';
import { Fragment } from 'react';

const AddNewUser = (props) => {
    const dispatch = useDispatch();
    const { arrListTypeUser, userEdit } = useSelector(state => state.UserReducers);

    useEffect(() => {
        dispatch(getListTypeUserApiAction())
    }, [])

    const { taiKhoan, matKhau, email, soDt, hoTen, maLoaiNguoiDung } = userEdit;
    const formik = useFormik({
        ...
        onSubmit: values => {
            dispatch(updateInfoPostUserApiAction(values))
        }
    })
                ...
                <div className="grid bg-white rounded-lg shadow-xl w-full">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                        <div className="grid grid-cols-1">
                            ...
                            <input disabled className="cursor-not-allowed py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" placeholder="Username" name="taiKhoan" onChange={formik.handleChange} value={formik.values.taiKhoan} />
                        ...
                        <div className="grid grid-cols-1">
                            ...
                            <input className="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="email" placeholder="Email" name="email" onChange={formik.handleChange} value={formik.values.email} />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                        <div className="grid grid-cols-1">
                            ...
                            <input className="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="password" placeholder="Password" name="matKhau" onChange={formik.handleChange} value={formik.values.matKhau} />
                        ...
                        <div className="grid grid-cols-1">
                            ...
                            <input className="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" placeholder="Phone number" name="soDt" onChange={formik.handleChange} value={formik.values.soDt} />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                        <div className="grid grid-cols-1">
                            ...
                            <input className="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" placeholder="Full name"
                                name="hoTen" onChange={formik.handleChange} value={formik.values.hoTen} />
                    ...
                    <div className="flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5">
                        ...
                        <button type="submit" className="w-auto bg-purple-500 hover:bg-purple-700 rounded-lg shadow-xl font-medium text-white px-4 py-2">Update</button>
                    </div>
                </div>
            </form>
        </>
